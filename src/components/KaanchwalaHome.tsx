...
export default async function KaanchwalaHome() {
  ...
  return <main>
    ...
    <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/95 backdrop-blur">
      <div className="container flex min-h-16 items-center justify-between gap-4 py-1.5">
        <Link href="/" aria-label={siteName} className="flex h-16 w-16 shrink-0 items-center justify-center sm:h-[72px] sm:w-[72px]">
