  ...
  return <main>
    ...
    <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/95 backdrop-blur">
      <div className="container flex min-h-14 items-center justify-between gap-3 py-1">
        <Link href="/" aria-label={siteName} className="flex h-11 w-11 shrink-0 items-center justify-center sm:h-12 sm:w-12">
          <Logo loading="eager" priority="high" className="h-10 w-10 sm:h-11 sm:w-11" />
        </Link>
