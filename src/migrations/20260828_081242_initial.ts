...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_technologies_category" AS ENUM('partner', 'framework', 'platform', 'tool');
  CREATE TYPE "public"."enum_team_members_social_links_platform" AS ENUM('linkedin', 'twitter', 'github', 'dribbble', 'website');
  CREATE TYPE "public"."enum_services_icon" AS ENUM('window', 'glass', 'folder', 'shape', 'loader2', 'palette', 'layout', 'megaphone', 'rocket', 'shield');
  CREATE TYPE "public"."enum_services_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__services_v_version_icon" AS ENUM('window', 'glass', 'folder', 'shape', 'loader2', 'palette', 'layout', 'megaphone', 'rocket', 'shield');
  CREATE TYPE "public"."enum__services_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__services_v_published_locale" AS ENUM('en', 'bg');
  ...
  CREATE TYPE "public"."enum__case_studies_v_published_locale" AS ENUM('en', 'bg');
  ...
  CREATE TYPE "public"."enum__faqs_v_published_locale" AS ENUM('en', 'bg');
  CREATE TYPE "public"."enum_leads_service" AS ENUM('frameless-partitions', 'aluminium-partitions', 'half-partitions', 'sliding-partitions', 'double-glazed', 'curved-partitions', 'glass-doors', 'office-glass', 'shower-enclosures', 'glass-railings', 'mirrors', 'custom-solutions');
  CREATE TYPE "public"."enum_leads_status" AS ENUM('New', 'Contacted', 'Qualified', 'Quoted', 'Converted', 'Closed');
  ...
  CREATE TYPE "public"."enum_header_cta_buttons_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_header_cta_buttons_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum_footer_columns_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('linkedin', 'twitter', 'github', 'youtube', 'instagram', 'facebook');
  CREATE TYPE "public"."enum_site_settings_social_links_platform" AS ENUM('linkedin', 'twitter', 'github', 'youtube', 'instagram', 'facebook');
  ...
  CREATE TABLE "pages_blocks_glass_options_options" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_glass_options" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "pages_blocks_installation_process_steps" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_installation_process" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "pages_blocks_logo_banner" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"display_type" "enum_pages_blocks_logo_banner_display_type" DEFAULT 'customers',
  	"heading" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_glass_options_options" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_glass_options" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_installation_process_steps" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_installation_process" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_logo_banner" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"display_type" "enum__pages_v_blocks_logo_banner_display_type" DEFAULT 'customers',
  	"heading" varchar,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "technologies" (
  	...
  	"logo_id" integer NOT NULL,
  	"website" varchar,
  	"category" "enum_technologies_category" DEFAULT 'tool',
  	"sort_order" numeric,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "team_members_social_links" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"platform" "enum_team_members_social_links_platform" NOT NULL,
  ...
  CREATE TABLE "demos" (
  	...
  	"slug" varchar NOT NULL,
  	"summary" varchar,
  	"demo_type" "enum_demos_demo_type" DEFAULT 'custom' NOT NULL,
  	"cover_image_id" integer,
  	"embed_url" varchar,
  	"content" jsonb,
  	"status" "enum_demos_status" DEFAULT 'active',
  	"sort_order" numeric,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "portfolio" (
  	...
  	"generate_slug" boolean DEFAULT true,
  	"slug" varchar NOT NULL,
  	"media_type" "enum_portfolio_media_type" DEFAULT 'image' NOT NULL,
  	"media_id" integer,
  ...
  CREATE TABLE "header_cta_buttons" (
  	...
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_header_cta_buttons_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar NOT NULL,
  	"link_appearance" "enum_header_cta_buttons_link_appearance" DEFAULT 'default'
  );
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'Agency Name' NOT NULL,
  ...
  ALTER TABLE "pages_blocks_glass_options_options" ADD CONSTRAINT "pages_blocks_glass_options_options_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_glass_options_options" ADD CONSTRAINT "pages_blocks_glass_options_options_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_glass_options"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_glass_options" ADD CONSTRAINT "pages_blocks_glass_options_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_installation_process_steps" ADD CONSTRAINT "pages_blocks_installation_process_steps_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_installation_process"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_installation_process" ADD CONSTRAINT "pages_blocks_installation_process_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_rels" ADD CONSTRAINT "pages_rels_legal_pages_fk" FOREIGN KEY ("legal_pages_id") REFERENCES "public"."legal_pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_glass_options_options" ADD CONSTRAINT "_pages_v_blocks_glass_options_options_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_glass_options_options" ADD CONSTRAINT "_pages_v_blocks_glass_options_options_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_glass_options"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_glass_options" ADD CONSTRAINT "_pages_v_blocks_glass_options_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_installation_process_steps" ADD CONSTRAINT "_pages_v_blocks_installation_process_steps_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_installation_process"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_installation_process" ADD CONSTRAINT "_pages_v_blocks_installation_process_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_rels" ADD CONSTRAINT "_pages_v_rels_legal_pages_fk" FOREIGN KEY ("legal_pages_id") REFERENCES "public"."legal_pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "case_studies" ADD CONSTRAINT "case_studies_client_id_customers_id_fk" FOREIGN KEY ("client_id") REFERENCES "public"."customers"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_case_studies_v" ADD CONSTRAINT "_case_studies_v_version_client_id_customers_id_fk" FOREIGN KEY ("version_client_id") REFERENCES "public"."customers"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "demos" ADD CONSTRAINT "demos_cover_image_id_media_id_fk" FOREIGN KEY ("cover_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "portfolio" ADD CONSTRAINT "portfolio_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "portfolio_rels" ADD CONSTRAINT "portfolio_rels_media_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_demos_fk" FOREIGN KEY ("demos_id") REFERENCES "public"."demos"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "header_rels" ADD CONSTRAINT "header_rels_legal_pages_fk" FOREIGN KEY ("legal_pages_id") REFERENCES "public"."legal_pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "footer_rels" ADD CONSTRAINT "footer_rels_legal_pages_fk" FOREIGN KEY ("legal_pages_id") REFERENCES "public"."legal_pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_glass_options_options_order_idx" ON "pages_blocks_glass_options_options" USING btree ("_order");
  CREATE INDEX "pages_blocks_glass_options_options_parent_id_idx" ON "pages_blocks_glass_options_options" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_glass_options_options_locale_idx" ON "pages_blocks_glass_options_options" USING btree ("_locale");
  CREATE INDEX "pages_blocks_glass_options_options_image_idx" ON "pages_blocks_glass_options_options" USING btree ("image_id");
  CREATE INDEX "pages_blocks_glass_options_order_idx" ON "pages_blocks_glass_options" USING btree ("_order");
  CREATE INDEX "pages_blocks_glass_options_parent_id_idx" ON "pages_blocks_glass_options" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_glass_options_path_idx" ON "pages_blocks_glass_options" USING btree ("_path");
  CREATE INDEX "pages_blocks_glass_options_locale_idx" ON "pages_blocks_glass_options" USING btree ("_locale");
  CREATE INDEX "pages_blocks_installation_process_steps_order_idx" ON "pages_blocks_installation_process_steps" USING btree ("_order");
  CREATE INDEX "pages_blocks_installation_process_steps_parent_id_idx" ON "pages_blocks_installation_process_steps" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_installation_process_steps_locale_idx" ON "pages_blocks_installation_process_steps" USING btree ("_locale");
  CREATE INDEX "pages_blocks_installation_process_order_idx" ON "pages_blocks_installation_process" USING btree ("_order");
  CREATE INDEX "pages_blocks_installation_process_parent_id_idx" ON "pages_blocks_installation_process" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_installation_process_path_idx" ON "pages_blocks_installation_process" USING btree ("_path");
  CREATE INDEX "pages_blocks_installation_process_locale_idx" ON "pages_blocks_installation_process" USING btree ("_locale");
  ...
  CREATE INDEX "pages_rels_legal_pages_id_idx" ON "pages_rels" USING btree ("legal_pages_id","locale");
  CREATE INDEX "pages_rels_categories_id_idx" ON "pages_rels" USING btree ("categories_id","locale");
  CREATE INDEX "pages_rels_portfolio_id_idx" ON "pages_rels" USING btree ("portfolio_id","locale");
  ...
  CREATE INDEX "_pages_v_blocks_glass_options_options_order_idx" ON "_pages_v_blocks_glass_options_options" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_glass_options_options_parent_id_idx" ON "_pages_v_blocks_glass_options_options" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_glass_options_options_locale_idx" ON "_pages_v_blocks_glass_options_options" USING btree ("_locale");
  CREATE INDEX "_pages_v_blocks_glass_options_options_image_idx" ON "_pages_v_blocks_glass_options_options" USING btree ("image_id");
  CREATE INDEX "_pages_v_blocks_glass_options_order_idx" ON "_pages_v_blocks_glass_options" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_glass_options_parent_id_idx" ON "_pages_v_blocks_glass_options" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_glass_options_path_idx" ON "_pages_v_blocks_glass_options" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_glass_options_locale_idx" ON "_pages_v_blocks_glass_options" USING btree ("_locale");
  CREATE INDEX "_pages_v_blocks_installation_process_steps_order_idx" ON "_pages_v_blocks_installation_process_steps" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_installation_process_steps_parent_id_idx" ON "_pages_v_blocks_installation_process_steps" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_installation_process_steps_locale_idx" ON "_pages_v_blocks_installation_process_steps" USING btree ("_locale");
  CREATE INDEX "_pages_v_blocks_installation_process_order_idx" ON "_pages_v_blocks_installation_process" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_installation_process_parent_id_idx" ON "_pages_v_blocks_installation_process" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_installation_process_path_idx" ON "_pages_v_blocks_installation_process" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_installation_process_locale_idx" ON "_pages_v_blocks_installation_process" USING btree ("_locale");
  ...
  CREATE INDEX "_pages_v_rels_legal_pages_id_idx" ON "_pages_v_rels" USING btree ("legal_pages_id","locale");
  CREATE INDEX "_pages_v_rels_categories_id_idx" ON "_pages_v_rels" USING btree ("categories_id","locale");
  CREATE INDEX "_pages_v_rels_portfolio_id_idx" ON "_pages_v_rels" USING btree ("portfolio_id","locale");
  ...
  CREATE UNIQUE INDEX "demos_slug_idx" ON "demos" USING btree ("slug");
  CREATE INDEX "demos_cover_image_idx" ON "demos" USING btree ("cover_image_id");
  CREATE INDEX "demos_updated_at_idx" ON "demos" USING btree ("updated_at");
  CREATE INDEX "demos_created_at_idx" ON "demos" USING btree ("created_at");
  CREATE UNIQUE INDEX "portfolio_slug_idx" ON "portfolio" USING btree ("slug");
  CREATE INDEX "portfolio_media_idx" ON "portfolio" USING btree ("media_id");
  ...
  CREATE INDEX "portfolio_rels_media_id_idx" ON "portfolio_rels" USING btree ("media_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_demos_id_idx" ON "payload_locked_documents_rels" USING btree ("demos_id");
  ...
  CREATE INDEX "header_rels_services_id_idx" ON "header_rels" USING btree ("services_id","locale");
  CREATE INDEX "header_rels_case_studies_id_idx" ON "header_rels" USING btree ("case_studies_id","locale");
  CREATE INDEX "header_rels_legal_pages_id_idx" ON "header_rels" USING btree ("legal_pages_id","locale");
  ...
  CREATE INDEX "footer_rels_services_id_idx" ON "footer_rels" USING btree ("services_id","locale");
  CREATE INDEX "footer_rels_case_studies_id_idx" ON "footer_rels" USING btree ("case_studies_id","locale");
  CREATE INDEX "footer_rels_legal_pages_id_idx" ON "footer_rels" USING btree ("legal_pages_id","locale");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_glass_options_options" CASCADE;
  DROP TABLE "pages_blocks_glass_options" CASCADE;
  DROP TABLE "pages_blocks_installation_process_steps" CASCADE;
  DROP TABLE "pages_blocks_installation_process" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_glass_options_options" CASCADE;
  DROP TABLE "_pages_v_blocks_glass_options" CASCADE;
  DROP TABLE "_pages_v_blocks_installation_process_steps" CASCADE;
  DROP TABLE "_pages_v_blocks_installation_process" CASCADE;
  ...
  DROP TYPE "public"."enum_header_cta_buttons_link_type";
  DROP TYPE "public"."enum_header_cta_buttons_link_appearance";
