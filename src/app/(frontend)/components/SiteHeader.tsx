  ...
  return (
    <header className="kw-header">
      ...
      <div className="container kw-nav">
        <Link href="/" className="kw-logo" aria-label="Kaanch Wala home"><Image src="/kaanchwala-logo.webp" alt="Kaanch Wala Glass & Mirror Solutions" width={176} height={60} priority unoptimized /></Link>
