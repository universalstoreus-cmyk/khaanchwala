  ...
  return (
    <header className="kw-header">
      ...
      <div className="container kw-nav">
        <Link href="/" className="kw-logo" aria-label="Kaanch Wala home"><Image src="/kaanchwala-logo.svg" alt="Kaanch Wala Glass & Mirror Solutions" width={176} height={66} priority /></Link>
