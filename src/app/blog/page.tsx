...
export const metadata: Metadata = {
  ...
  description: 'Latest articles and insights from Kaanchwala Glass & Mirror Solutions',
}
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 line-clamp-2">
                      {post.meta?.description || 'Latest article from Kaanchwala Glass & Mirror Solutions'}
                    </p>
                  </div>
                </Link>
              ))}
