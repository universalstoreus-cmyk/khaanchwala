              ...
              <div>
                ...
                <div className="space-y-4 text-gray-600 dark:text-gray-300">
                  <div className="flex items-start gap-4">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.12 2 19.96 19.96 0 0 1 2 4.88v-3.02c0-2.01 1.59-3.61 3.93-3.72 3.34-.26 3.93 1.37 3.93 3.72v3.02c0 1.55.42 3.06 1.18 4.23a8.01 8.01 0 0 1-.63 1.44A2.96 2.96 0 0 1 2 19.88a2 2 0 0 1-1.94-1.82A7.98 7.98 0 0 1 5 .73a2 2 0 0 1 .99-1.43 8.02 8.02 0 0 1 1.56-.06 2.97 2.97 0 0 1 2.83.19 7.99 7.99 0 0 1 2.65 2.34 2 2 0 0 1-.8 2.14 2 2 0 0 1-.76 4.06 7.98 7.98 0 0 1-.03 3.98 2 2 0 0 1-1.13.45 9.86 9.86 0 0 1-2.31 1.11A11.92 11.92 0 0 1 2 22v3h46v-3a11.92 11.92 0 0 1-2.3-1.11 2 2 0 0 1-1.13-.45 7.98 7.98 0 0 1-.03-3.98 2 2 0 0 1-1.56-.06 7.99 7.99 0 0 1-2.65-2.34 2 2 0 0 1-.76-4.06 2 2 0 0 1-.8-2.14A2 2 0 0 1 2 4.88zM7 10l5 4.5L7 15V10z" /></svg>
                    <div><p className="font-medium">{siteSettings?.contactPhone || '+1 (234) 567-890'}</p><p className="text-sm">Mon - Sat: 9AM - 6PM</p></div>
                  </div>
                  <div className="flex items-start gap-4">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2zM4 8h16v7H4V8zm6 4h4v2h-4v-2zm0 4h4v2h-4v-2z" /></svg>
                    <div><p className="font-medium">{siteSettings?.address || '123 Glass Street, City Center'}</p><p className="text-sm">{siteSettings?.contactEmail || 'info@kaanchwala.com'}</p></div>
                  </div>
                </div>
