...
export default async function ServiceDetailPage({
  ...
  return (
    <div className="min-h-screen">
      <Head>
        <title>{service.title || 'Glass Solutions'} | Kaanchwala Glass & Mirror Solutions</title>
        <meta
          name="description"
          content={service.meta?.description || 'Premium glass solutions for modern spaces'}
        />
      </Head>
              ...
              {service.content && (
                <div className="mb-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    {service.content?.children?.[0]?.children?.[0]?.text || 'Various types and finishes available.'}
                  </p>
                </div>
              )}

              {/* Gallery */}
              {/* TODO: Add gallery component when media is available */}
